...
export const DEMO_VILLAGES = [
  {
    ...
    founded: 'Sep 2025',
    memberList: [
      { id: 'm1', initials: 'JL', name: 'Jordan L.', role: 'Founder',   contrib: 3200, status: 'active',  joined: 'Sep 4, 2025',  photo: 'https://randomuser.me/api/portraits/men/75.jpg' },
      ...
      { id: 'm3', initials: 'AT', name: 'Alex T.',   role: 'Member',    contrib: 3200, status: 'active',  joined: 'Sep 4, 2025',  photo: 'https://randomuser.me/api/portraits/men/35.jpg' },
    ...
    recentActivity: [
      ...
      { type: 'allocation',   actor: 'Village',      amount: 3200, date: 'Dec 18', note: 'Allocated to Alex T.: federal loan payoff (cycle 3)' },
    ...
    chat: [
      ...
      { id: 'c3',  author: 'You',       initials: 'JL', photo: 'https://randomuser.me/api/portraits/men/75.jpg',   text: 'Confirmed on my end too.', time: 'Feb 26, 9:31 AM', mine: true },
      ...
      { id: 'c7',  author: 'You',       initials: 'JL', photo: 'https://randomuser.me/api/portraits/men/75.jpg',   text: 'Let\'s put it to a vote. I\'ll create a motion.', time: 'Feb 27, 2:21 PM', mine: true },
      { id: 'c8',  author: 'Alex T.',   initials: 'AT', photo: 'https://randomuser.me/api/portraits/men/35.jpg',   text: 'Agreed. The fund is at $24k now, we have room.', time: 'Feb 27, 2:22 PM', mine: false },
      ...
      { id: 'c12', author: 'You',       initials: 'JL', photo: 'https://randomuser.me/api/portraits/men/75.jpg',   text: 'Resolution is up. Check the Votes tab, closes in 3 days.', time: 'Feb 27, 4:00 PM', mine: true },
    ],
    votes: [
      { id: 'vote-1', title: 'Allocate $3,200 to Amara K.: Education Loan', description: 'Amara has been a consistent contributor since day one and has $18k remaining on her federal loan. Allocating this month\'s pool to her aligns with our group goal and our rotating payout structure.', amount: 3200, status: 'open', yes: 5, no: 1, abstain: 1, total: 8, proposedBy: 'Jordan L.', myVote: null, expiresAt: new Date('2026-03-21T23:59:00').getTime() },
      { id: 'vote-2', title: 'Increase monthly contribution to $450 from April', description: 'A small bump would accelerate our pooling timeline by approximately 3 months without straining members on income-driven repayment. Alex ran the projections; see the attached note in chat.', amount: 450, status: 'open', yes: 3, no: 2, abstain: 0, total: 8, proposedBy: 'Alex T.', myVote: null, expiresAt: new Date('2026-03-23T23:59:00').getTime() },
      { id: 'vote-3', title: 'Allocate $2,400 to Richie G.: Education Debt', description: 'Richie has $9,600 remaining on his federal loan and is next in the rotation. Full consensus on this one.', amount: 2400, status: 'passed', yes: 7, no: 0, abstain: 1, total: 8, proposedBy: 'Jordan L.', myVote: 'yes', expiresAt: new Date('2026-02-20T23:59:00').getTime() },
      ...
      { id: 'vote-5', title: 'Allocate $3,200 to Alex T.: Student Loan (cycle 3)', description: '', amount: 3200, status: 'passed', yes: 8, no: 0, abstain: 0, total: 8, proposedBy: 'Jordan L.', myVote: 'yes', expiresAt: new Date('2025-12-18T23:59:00').getTime() },
  ...
  },
  {
    ...
    founded: 'Nov 2025',
    memberList: [
      { id: 'm1', initials: 'JL', name: 'Jordan L.', role: 'Member',    contrib: 1350, status: 'active',  joined: 'Nov 14, 2025', photo: 'https://randomuser.me/api/portraits/men/75.jpg' },
    ...
    recentActivity: [
      ...
      { type: 'join',         actor: 'Jordan L.',    amount: null, date: 'Nov 14', note: 'New member joined, referred by Olu T.' },
    ],
    chat: [
      { id: 'c1',  author: 'Carmen J.', initials: 'CJ', photo: 'https://randomuser.me/api/portraits/women/48.jpg', text: 'Welcome to the group Jordan! Glad Olu brought you in. We\'re focused and consistent here, you\'ll fit right in.', time: 'Nov 14, 9:00 AM', mine: false },
      { id: 'c2',  author: 'You',       initials: 'JL', photo: 'https://randomuser.me/api/portraits/men/75.jpg',   text: 'Thanks Carmen. Happy to be here: I\'ve been wanting to build up an emergency fund for a while.', time: 'Nov 14, 9:22 AM', mine: true },
      ...
      { id: 'c7',  author: 'You',       initials: 'JL', photo: 'https://randomuser.me/api/portraits/men/75.jpg',   text: 'Works for me. That\'s manageable.', time: 'Dec 10, 11:35 AM', mine: true },
      ...
      { id: 'c9',  author: 'You',       initials: 'JL', photo: 'https://randomuser.me/api/portraits/men/75.jpg',   text: 'Great pace. Anyone want to discuss bumping contributions in April?', time: 'Mar 2, 10:15 AM', mine: true },
    ...
    votes: [
      ...
      { id: 'vote-a4', title: 'Admit Jordan L. as member (referred by Olu T.)', description: 'Jordan is a PhD student with a stable stipend income and a clear savings goal. Olu vouches for them directly.', amount: null, status: 'passed', yes: 4, no: 0, abstain: 1, total: 5, proposedBy: 'Olu T.', myVote: null, expiresAt: new Date('2025-11-10T23:59:00').getTime() },
...
export const EXPLORE_VILLAGES = [
  ...
  },
  {
    ...
    intervalLabel: 'Monthly', myContribution: 0, nextContribution: 0, nextDate: 'Pending',
    structure: { accountType: 'brokerage', payInFrequency: 'monthly', poolTarget: 500000, minContribution: 400, payoutStructure: 'voted', amendmentThreshold: 'two_thirds', quorum: 'all', dishonorableExit: 'returned_with_interest', probationPeriod: '6_months', latePaymentPolicy: 'grace_7', exitNoticePeriod: '3_months', memberAdmission: 'invite_no_vote', portfolioAllocation: { equities: 80, bonds: 20 } },
    memberList: [
  ...
  },
  {
    ...
    intervalLabel: 'Monthly', myContribution: 0, nextContribution: 0, nextDate: 'Pending',
    structure: { accountType: 'brokerage', payInFrequency: 'monthly', poolTarget: 250000, minContribution: 400, payoutStructure: 'voted', amendmentThreshold: 'two_thirds', quorum: 'two_thirds', dishonorableExit: 'returned_with_interest', probationPeriod: '3_months', latePaymentPolicy: 'grace_7', exitNoticePeriod: '3_months', memberAdmission: 'vote_required', portfolioAllocation: { equities: 85, bonds: 10, cash: 5 } },
    memberList: [
