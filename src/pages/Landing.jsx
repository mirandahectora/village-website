...
function HeroSection() {
  ...
  return (
    <section style={{
      ...
      <div style={{
        padding: isMobile ? '40px 24px 48px' : '40px 64px 80px 32px',
        ...
        <div className="fade-up fade-up-2" style={{
          ...
          {' '}
          <Typewriter
            text={['invest for the future.', 'save money for emergencies.', 'pay off big debts.', 'fund a new project.', 'be financially independent.', 'build out your dream.', 'thrive.']}
            speed={70}
            waitTime={1800}
            deleteSpeed={40}
            cursorChar="_"
    ...
    <section id="what-is-village" style={{ borderBottom: '1px solid var(--rule)' }}>
      ...
      <div ref={ref} style={{
        ...
        <div style={{
          ...
          <div style={{ padding: isMobile ? '40px 24px' : '80px 48px' }}>
  ...
  return (
    <section style={{ borderBottom: '1px solid var(--rule)' }}>
      ...
      <div id="waitlist" ref={ref} style={{
        ...
        <div style={{ padding: isMobile ? '40px 24px' : '72px 64px', borderRight: isMobile ? 'none' : '1px solid var(--rule)', borderBottom: '1px solid var(--rule)' }}>
        ...
        <div style={{ padding: isMobile ? '40px 24px' : '72px 64px', borderBottom: '1px solid var(--rule)', background: 'var(--cream-mid)' }}>
          <WaitlistForm />
        </div>
      </div>
      ...
      <div id="partnerships" style={{
        ...
        <div style={{ padding: isMobile ? '40px 24px' : '64px 64px' }}>
  ...
  return (
    <div ref={ref} style={{
      ...
      <div style={{
        ...
        borderRight: isMobile ? 'none' : (isEven ? 'none' : '1px solid var(--rule)'),
        borderLeft: isMobile ? 'none' : (isEven ? '1px solid var(--rule)' : 'none'),
        borderBottom: '1px solid var(--rule)',
      }}>
