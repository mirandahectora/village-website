...
const STRUCTURE_LABELS = {
  ...
  dishonourableExit:  { withheld: 'Funds withheld', returned_no_interest: 'Returned, no interest', returned_with_interest: 'Returned with interest' },
...
function JoinModal({ v, onConfirm, onCancel }) {
  ...
  const constitutionRows = s ? [
    ...
    ['Dishonourable exit',   STRUCTURE_LABELS.dishonourableExit[s.dishonourableExit]],
