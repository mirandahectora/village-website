...
export default function Nav() {
  ...
  return (
    <nav style={{
      ...
      background: scrolled || menuOpen ? 'rgba(244,238,226,0.97)' : 'transparent',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 16 }}>
            {user ? (
              ...
              <>
                <Link to="/auth?mode=signup" className="btn btn-primary" style={{ justifyContent: 'center' }}>
                  Join
                </Link>
                <Link to="/auth" className="btn btn-terra" style={{ justifyContent: 'center' }}>
                  Sign In
                </Link>
              </>
            )}
